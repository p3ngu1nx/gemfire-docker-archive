...
(sleep 50; echo "***************  DONE **************"; docker exec -it envear_server_1 cat server1/persistData1/BACKUPds1_1.crf; docker logs envear_server_1; docker exec -it envear_server_1 cat /Pivotal_GemFire/SampleCode/quickstart/server1/server1.log; docker-compose down ;)