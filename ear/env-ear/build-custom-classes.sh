...
rsync -rv --include '/' --include 'Oplog.class' --exclude '*' --prune-empty-dirs /bk/Dev/gemfire/incubator-geode/gemfire-core/build/classes/main/com/gemstone/gemfire/internal/cache/ server/bin/com/gemstone/gemfire/internal/cache/
rsync -rv --include '/' --include 'Oplog$*.class' --exclude '*' --prune-empty-dirs /bk/Dev/gemfire/incubator-geode/gemfire-core/build/classes/main/com/gemstone/gemfire/internal/cache/ server/bin/com/gemstone/gemfire/internal/cache/

rsync -rv --include '/' --include 'DiskEntry.class' --exclude '*' --prune-empty-dirs /bk/Dev/gemfire/incubator-geode/gemfire-core/build/classes/main/com/gemstone/gemfire/internal/cache/ server/bin/com/gemstone/gemfire/internal/cache/
rsync -rv --include '/' --include 'DiskEntry$*.class' --exclude '*' --prune-empty-dirs /bk/Dev/gemfire/incubator-geode/gemfire-core/build/classes/main/com/gemstone/gemfire/internal/cache/ server/bin/com/gemstone/gemfire/internal/cache/
